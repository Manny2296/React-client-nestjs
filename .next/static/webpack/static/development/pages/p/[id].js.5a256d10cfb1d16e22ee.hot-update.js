      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            _context.next = 3;
            return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()("http://localhost:3001/products/".concat(id)).then(function (response) {
...
//# sourceMappingURL=[id].js.5a256d10cfb1d16e22ee.hot-update.js.map